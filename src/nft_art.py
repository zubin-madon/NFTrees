...
# __pragma__ ('ecom')
    ...
    if 8 <= LEAVES_NEEDED <= 14:
        ...
        tb.asym_roots(nib_name=nibs['root'],
                      ROOTS=ROOTS,
                      length=random.randrange(70, 90, 10), levels=3,
                      angle=(random.randrange(45, 55, 5)),
                      root_palette=root_palette,
                      pensize=7)
    ...
    if 31 <= LEAVES_NEEDED <= 47:
        functions_ = [
            (tb.sym_tree, (nibs['tree'], 100, level_tree, random.randrange(10, 40, 10), 0.75, palette, LEAVES, 10)),
    ...
    if 48 <= LEAVES_NEEDED <= 127:
        ...
        functions_ = [
            (tb.sym_tree, (nibs['tree'], 130, level_tree, random.randrange(15, 45, 10), 0.75, palette, LEAVES, 10)),
    ...
    if 128 <= LEAVES_NEEDED <= 300:
        ...
        functions_ = [
            (tb.sym_tree, (nibs['tree'], 130, level_tree, random.randrange(20, 45, 5), 0.75, palette, LEAVES, 10)),
            (tb.asymmetric_tree_under600,
             (nibs['tree'], LEAVES, random.randrange(120, 140, 20), random.randint(6, 8), random.choice(angle_range), palette, 10, True)
             )
        ]
        x = random.choice(functions_)
        x[0](*x[1])
    ...
    if 301 <= LEAVES_NEEDED <= 700:
        angle_range = [random.randrange(-45, -15, 10), random.randrange(15, 45, 10)]
        functions_ = [
            (tb.sym_tree, (nibs['tree'], 120, level_tree, random.randrange(15, 55, 10), 0.75, palette, LEAVES, 10)),
            (tb.asymmetric_tree_under600,
             (nibs['tree'], LEAVES, random.randrange(130, 140, 10), random.randint(8, 9), random.choice(angle_range), palette, 10, True)
             )
        ]
        x = random.choice(functions_)
        x[0](*x[1])
    ...
    if 701 <= LEAVES_NEEDED:
        ...
        random.random()
        functions_ = [
            (tb.sym_tree, (nibs['tree'], 120, level_tree, random.randrange(15, 45, 10), 0.8, palette, LEAVES, 10)),
            (tb.asymmetric_tree_under600,
             (nibs['tree'], LEAVES, random.randrange(110, 130, 10), random.randint(9, 10), random.choice(angle_range), palette, 10, True)
             )
        ]
        x = random.choice(functions_)
        x[0](*x[1])
